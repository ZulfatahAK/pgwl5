            ...
            <form action="{{ route('points.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name_point" name="name" placeholder="Fill name here">
                    </div>
                    <div class="mb-3">
            ...
            <form action="{{ route('polylines.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name_polyline" name="name" placeholder="Fill name here">
                    </div>
                    <div class="mb-3">
            ...
            <form action="{{ route('polygons.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name_polygon" name="name" placeholder="Fill name here">
                    </div>
                    <div class="mb-3">
...
<script>
        ...
        onEachFeature: function(feature, layer) {
            ...
            var popup_content =
                ...
                (feature.properties.image
                    ? "<img src='{{ asset('storage/images') }}/" + feature.properties.image + "' class='img-thumbnail' width='200'><br><br>"
                    : "") +
                "<div class='d-flex gap-2 mt-2'>" +
                    "<form action='" + routedelete + "' method='POST' onsubmit='return confirm(\"Yakin ingin menghapus?\")'>" +
    ...
    "<div class='d-flex gap-2 mt-2'>" +
        "<form action='" + routedelete + "' method='POST' onsubmit='return confirm(\"Yakin ingin menghapus?\")'>" +
            ...
            "<button class='btn btn-sm btn-danger'><i class='fa-solid fa-trash'></i> Hapus</button>" +
        "</form>" +
        "<a href='" + routeedit + "' class='btn btn-sm btn-warning'>" +  // ← tombol edit
